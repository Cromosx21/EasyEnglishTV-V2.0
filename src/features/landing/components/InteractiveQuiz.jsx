        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="flex-1 text-center lg:text-left">
                <div className="inline-flex items-center gap-2 bg-white/10 text-white px-4 py-2 rounded-full mb-6 border border-white/20 backdrop-blur-sm">
                    ...
                    <span className="font-bold text-sm uppercase tracking-wide">Desafío EETV</span>
                </div>
                <h2 className="text-4xl sm:text-5xl font-extrabold text-white mb-6 leading-tight">
                    ¿Cuál es tu nivel <br/>
                    <span className="text-brand-yellow">real de inglés?</span>
                </h2>
                <p className="text-xl text-blue-100 mb-10 max-w-lg mx-auto lg:mx-0">
                    No pierdas tiempo en cursos que no son para ti. Toma nuestro test inteligente y descubre tu ruta de aprendizaje ideal en 5 minutos.
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                     <Card className="bg-white/10 border-white/20 backdrop-blur-md hover:bg-white/20 transition-colors cursor-pointer group flex-1 max-w-xs">
                        <CardContent className="p-6 flex items-center gap-4 text-left">
                            ...
                            <div>
                                <h3 className="font-bold text-white text-lg">Test Rápido</h3>
                                <p className="text-blue-100 text-xs font-medium">5 minutos • General</p>
                            </div>
                     ...
                     <Card className="bg-white hover:bg-gray-50 transition-colors cursor-pointer group flex-1 max-w-xs border-none shadow-xl">
                        <CardContent className="p-6 flex items-center gap-4 text-left">
                            ...
                            <div>
                                <h3 className="font-bold text-brand-dark text-lg">Test Profundo</h3>
                                <p className="text-gray-500 text-xs">20 minutos • Preciso</p>
                            </div>
                ...
                <div className="relative bg-white rounded-[2.5rem] shadow-2xl p-2 rotate-2 hover:rotate-0 transition-transform duration-500">
                    <div className="bg-gray-50 rounded-[2rem] overflow-hidden border border-gray-100">
                        ...
                        <div className="bg-white p-6 border-b border-gray-100 flex justify-between items-center">
                            <span className="font-bold text-gray-400">Question 3/10</span>
                        ...
                        <div className="p-8">
                            ...
                            <h3 className="text-xl font-bold text-gray-800 mb-6 text-center">Select the correct verb form:</h3>
                            <div className="space-y-3">
                                {['She ___ to the store yesterday.', 'She go', 'She went', 'She gone'].map((opt, i) => (
                                    <div key={i} className={`p-4 rounded-xl border-2 font-medium cursor-pointer transition-all ${i === 2 ? 'border-brand-blue bg-brand-light text-brand-blue shadow-sm' : 'border-gray-100 hover:border-gray-200 text-gray-600'}`}>
                                        {opt.includes('___') ? <span className="text-lg italic">{opt}</span> : opt}
                                        {i === 2 && <span className="float-right">✅</span>}
                                    </div>
                                ))}
                            </div>
                        </div>
                        <div className="bg-gray-50 p-6 text-center">
                            <Button className="w-full bg-brand-dark text-white rounded-xl py-6">Next Question</Button>
                        </div>
                    </div>
                </div>
            </div>
