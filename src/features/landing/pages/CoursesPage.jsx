	...
	return (
		<div className="bg-white min-h-screen pb-20">
			...
			<section className="bg-brand-blue/5 py-20 px-4">
				<div className="max-w-7xl mx-auto flex flex-col mt-20 lg:flex-row items-center gap-12">
					<div className="flex-1 text-center lg:text-left">
						...
						<a href="#AllCourses">
							<Button className="bg-rose-500 hover:bg-rose-600 text-white rounded-full px-8 py-6 shadow-lg shadow-rose-500/20 text-lg cursor-pointer">
			...
			{/* Courses Grid */}
			<section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" id="AllCourses">
						...
						>
							...
							<div className="flex-1 py-2">
								...
								<div className="flex items-center justify-between ">
									...
									<Button
										size="icon"
										className="w-fit px-4 bg-brand-light hover:bg-brand-blue text-brand-blue hover:text-white transition-all cursor-pointer hover:-translate-y-1"
										onClick={(e) =>
